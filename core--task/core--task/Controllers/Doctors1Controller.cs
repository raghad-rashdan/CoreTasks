...
namespace core__task.Controllers
{
    public class Doctors1Controller : Controller
    {
        ...
        public Doctors1Controller(CoreTaskContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DoctorId,DoctorName,DoctorImg,DoctorEmail,ClinicId")] Doctor doctor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DoctorId,DoctorName,DoctorImg,DoctorEmail,ClinicId")] Doctor doctor)
        {
